  ...
  void _initializeSocket() {
    ...
    SocketService.listenToTransactionUpdates((data) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'New order received! Order ID: ${data['transaction_id']}',
          ),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder:
                (context) => ExpandNewOrder(
                  userId: widget.userId,
                  token: widget.token,
                  shopData: widget.shopData,
                  onOrderAccepted:
                      _refreshOrders, // This will refresh all order listst
                ),
          ),
        );
      },
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                ongoingOrders.first['service_name']
                                        ?.toString()
                                        .toUpperCase() ??
                                    'SERVICE',
                                style: const TextStyle(
