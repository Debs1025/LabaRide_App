...
class _LaundryDashboardScreenState extends State<LaundryDashboardScreen> {
  ...
  Future<void> _initializeData() async {
    try {
      ...
      await Future.wait([_fetchUserData(), _fetchShopData()]);
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                transactionMessage!,
                style: const TextStyle(color: Color(0xFF1A0066), fontSize: 14),
              ),
            ),
            const Icon(
  ...
  Widget _buildNavItem(
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          Icon(icon, color: isActive ? const Color(0xFF375DFB) : Colors.grey),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              if (title !=
                  'Nearby Laundry Shops') // Only show View All for non-nearby shops
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
