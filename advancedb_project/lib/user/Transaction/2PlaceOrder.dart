...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _placeOrder() async {
    ...
    final transactionData = {
      ...
      'user_name': widget.shopData['user_name'] ?? '',
      'user_email': widget.shopData['email'] ?? '',
      'user_phone': widget.shopData['phone'] ?? '',
      'service_name': widget.services,
      'kilo_amount': _kiloAmount,
  ...
  Future<double> _getPricePerKilo(double kiloAmount) async {
    try {
      final response = await http.get(
        Uri.parse(
          'http://localhost:5000/shop/${widget.shopData['id']}/kilo-prices',
        ),
        headers: {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              initialValue: _kiloAmount.toString(),
              ...
              onChanged: (value) async {
                ...
                setState(() {
                  _kiloAmount = kiloAmount;
                });
                await _updateSubtotal();
              },
              validator: (value) {
  ...
  Future<void> _updateSubtotal() async {
    try {
      ...
      // Calculate subtotal as needed
      setState(() {
        _currentSubtotal = pricePerKilo * kiloAmount;
      });
    } catch (e) {
                  ...
                  (item) => Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        // You may want to update this price logic as needed
                        Text(
                          '₱0.00', // Placeholder, update with your price logic
                          style: TextStyle(
                            color: navyBlue,
